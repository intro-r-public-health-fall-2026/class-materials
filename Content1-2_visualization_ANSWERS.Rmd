...
ggplot(data = nmes.data, mapping = aes(group = 1)) + 
  geom_bar(mapping = aes(x = mscd, y = after_stat(prop)))
```
...
ggplot(data = nmes.data) + 
  geom_bar(mapping = aes(x = eversmk, y = after_stat(count), fill = mscd), position = "fill")
```
...
```{r}
ggplot(data = nmes.data) + 
  geom_bar(mapping = aes(x = mscd, y = after_stat(count), fill = eversmk), position = "fill")
```
